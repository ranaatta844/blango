...
class PostApiTestCase(TestCase):
  ...
  def test_post_list(self):
    ...
    for post_dict in data:
        ...
        self.assertEqual(
            ...
            datetime.strptime(
              post_dict["published_at"], "%Y-%m-%dT%H:%M:%S.%fZ").replace(tzinfo=UTC),
              )
  
  # methon to test unauthenticated post creation
  ...
  # method for teh test post autheticated user post creation
